...
if ( ! ($_SESSION['autenticado'] == 'SI' && isset($_SESSION['usuario'])) )
{
   //En caso de que el usuario no este autenticado, crear un f1 y redireccionar a la pantalla de login, enviando un codigo de error
	...
	exit();
    header("Location:../clientes/menu_g_c2.php");
}
...
<form action="procesarDatos2.php?modo=MODIFICAR" method="post" NAME="f1"  onSubmit="return validar(this)"> 
<TABLE>
<TR> 
...
<TR> 
   ...
   <TD class="Estilo1"><INPUT TYPE="text" NAME="apellido1" SIZE="40" MAXLENGTH="60" value="<?=$fila2["APELLIDO1"]?>"></TD> 
</TR> 

<TR> 
   <TD class="Estilo1">Nombre comercial:</TD> 
   <TD class="Estilo1"><INPUT TYPE="text" NAME="apellido2" SIZE="40" MAXLENGTH="60" value="<?=$fila2["APELLIDO2"]?>"></TD> 
</TR> 
