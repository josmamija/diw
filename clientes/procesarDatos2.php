...
if (isset($_POST['accion'])) { 
	...
	if (!$EsValido) {
		...
		elseif ($_GET['modo'] == "MODIFICAR") { 
    		...
    		$_SESSION['UrlDestino']="modificar2.php";
 ...
 elseif (isset($_POST['borrar']) || isset($_GET['idCliente']) ) {
			include ("../Conexiones/conexion_local.php");
			if (isset($_POST['borrar'])){
				$idCliente=  $_POST["id"];
				$_SESSION['UrlDestino']="../clientes/modificar2.php";
			}else {
				$idCliente=  $_GET['idCliente'];
				$_SESSION['UrlDestino']="../clientes/listado.php";
			}
			$enllac = mysql_connect($servidor,$usuari,$contrasenya);
			mysql_select_db($baseDatos,$enllac);
