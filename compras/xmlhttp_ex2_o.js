...
{         
 var gatFinestra = window.open(enlace,"FinestraGat","resizable=no,width=450,height=450, top=120,left=100");  
   return false;    
}    
...
function mostrarTabla(){
	...
	if(i<1){
		...
		missatge="<table border ='1' class='rounded'><tr class='cabecera'><td> Proveedor</td><td> Codigo</td><td> Marca</td>";
 		missatge+="<td> Descripción</td><td> PVP</td><td>P_NETO</td><td> Uds.</td><td> Info técnica</td></tr>";	
  		var ico = "<img src='../images/cancel.gif' width='25 height='25' />";
   		var icoinfo = "<img src='../images/inboxold.gif' width='18 height='18' />";
		var tip ="Borrar";
