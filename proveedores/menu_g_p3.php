...
<div id="apDiv2">
    ...
    <div id = "cuerpo"  align="left" class="letratext">
      <ul id="llista_imatges" class="rounded" style="background-color: #333;color: #CF9">
		    <li><strong><em>PROVEEDOR</em></strong></li>
        <li>&nbsp;&nbsp;&nbsp;</li>
      ...
      <p></p>
     <p align="right"><em>Exp&oacute;n tus productos a una
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <br /> clientela profesional &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</em></p>
      ...
      <div style=" display:inline-block">
        ...
        <div style="float:left; width:50px; padding-top:20px">
          ...
          <img src="../images/proveedores.png" width="163" height="120" />
        </div>
   	  </div>
      ...
      <div style=" display:inline-block">
        <div class="rounded" style="background-color:#9C0;float:left;width:185px;height:126px; padding-top:7px " align="center"  >
          <img src="../images/dormido.png" width="159" height="115" />
        </div>
        <div style="float:left; width:20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        <div style="float:left; width:20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <p align="right">
        <em>
          ...
          trabajo y además para tus&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> 
          hobbys o compras cotidianas&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;<br>
     ...
     <p> <a href="https://twitter.com/gesdescCom/" target="_blank">
     <img src="../images/twitter.jpg" width="68" height="65" alt="twitter" /></a>
