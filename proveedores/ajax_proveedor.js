...
{ 
  ...
  {  
    ...
    peticio_http.open("POST", "../proveedores/validaProveedor.php", true); 
...
{  
  ...
  {  
    ...
    {  
	  ...
	  //document.getElementById("resposta").innerHTML = peticio_http.responseText;
	  document.getElementById("resposta_existe_prov").innerHTML = peticio_http.responseText;
