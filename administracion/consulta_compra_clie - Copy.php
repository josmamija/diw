...
<script src="../clientes/respond.min.js"></script>
</head>
...
if (isset($_SESSION['usuario']) && ($_SESSION['autenticado'] == 'SI')) {
	if (isset($_POST['Submit']) || isset($_GET['compra'])) {
		...
		$cadena.= "<td>Marca</td><td>Descripción</td><td>C. Fábrica</td><td>Uds.</td><td>PVP</td><td>P.FINAL</td></tr>";
		$ct=0;
	...
	echo "<a href=../proveedores/login_prov.php> Login</a>";
}
 ?>
 <!--
