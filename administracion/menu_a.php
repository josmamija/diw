...
<body >
    <div class="container">
    	<div class="row">
			<div class="span6">
            	<img src="../images/logo_gesdes.jpg" width="392" height="214" /> 
                <ul class="nav nav-list"  style="font-size:x-large">
                <li class="nav-header"><span class="curved-box-css4"  style="font-size:x-large">Administración</span></li>
